const prefijoABandera = {
  ...
  '880': '🇧🇩', '886': '🇹🇼', '960': '🇲🇻', '961': '🇱🇧', '962': '🇯🇴', '963': '🇸🇾', '964': '🇮🇶',
  '965': '🇰🇼', '966': '🇸🇦', '967': '🇾🇪', '968': '🇴🇲', '970': '🇵🇸', '971': '🇦🇪', '972': '🇮🇱',
  '973': '🇧🇭', '974': '🇶🇦', '975': '🇧🇹', '976': '🇲🇳', '977': '🇳🇵', '992': '🇹🇯', '993': '🇹🇲',
  '994': '🇦🇿', '995': '🇬🇪', '996': '🇰🇬', '998': '🇺🇿', '1787': '🇵🇷', '1809': '🇩🇴', '1829': '🇩🇴',
  '1849': '🇩🇴', '1868': '🇹🇹', '1876': '🇯🇲', '1758': '🇱🇨', '1345': '🇰🇾', '1441': '🇧🇲',
  '1649': '🇹🇨', '1721': '🇸🇽', '1264': '🇦🇮', '1473': '🇬🇩', '1869': '🇰🇳'
};
...
const handler = async (m, { conn, participants, isAdmin, isOwner }) => {
  ...
  // Enviar primero el video
  await conn.sendMessage(m.chat, {
    video: { url: 'https://files.catbox.moe/gsyptn.mp4' },
    caption: '🔥 ¡MENCION GENERAL ACTIVADA! 🔥',
  });

  // Luego enviar la lista de menciones
  await conn.sendMessage(m.chat, {
    text: texto,
